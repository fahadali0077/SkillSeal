    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      <div className="mb-6 pb-4 border-b border-paper-line">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display text-[28px] leading-none text-ink-900">Browse verified jobs</h1>
            <p className="text-sm text-ink-500 mt-2">Find roles where your skills are proven, not promised</p>
          </div>
        </div>
      </div>
