...
export default function UpgradePrompt({feature,description,requiredPlan='pro',variant='card',className=''}:Props){
  ...
  return(<motion.div initial={{opacity:0,scale:0.97}} animate={{opacity:1,scale:1}} className={`border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center ${className}`}>
