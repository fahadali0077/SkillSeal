  ...
  return (
    <AuthShell>
      <div className="card p-6 sm:p-8">
        ...
        <p className="text-sm text-gray-500 mb-6">Sign in to continue to SkillSeal</p>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`input pr-10 ${errors.password ? 'border-red-400 focus:ring-red-400/20' : ''}`}
                placeholder="••••••••"
                {...register('password')}
              />
              <button
        ...
        <div className="my-6 flex items-center gap-3">
          ...
          <span className="text-[11px] uppercase tracking-wider text-gray-400 font-medium">New to SkillSeal?</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
      ...
      <p className="mt-6 text-center text-xs text-gray-400">
        ...
        <Link to="/terms" className="text-gray-500 hover:text-brand transition-colors">Terms</Link>
        {' '}and{' '}
        <Link to="/privacy" className="text-gray-500 hover:text-brand transition-colors">Privacy Policy</Link>.
      </p>
    </AuthShell>
  );
}
