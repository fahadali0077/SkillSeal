...
export async function sendRequest(
  ...
  // appears in the sender's "People you may know" list (and vice-versa)
  // until the 1-hour Redis TTL expires, even though the relationship is
  // now 'pending' and the suggestions service correctly filters pending
  // users. This matches the pattern used in accept/decline/remove/block.
  await bustSuggestions(senderId, recipientId);
