...
export const SOCKET_EVENTS = { SESSION_ACTION:'session_action', NOTIFICATION:'notification', JOIN_ROOM:'join_room', NEW_MESSAGE:'new_message', TYPING:'typing', STOP_TYPING:'stop_typing', TYPING_START:'typing_start', TYPING_STOP:'typing_stop', USER_ONLINE:'user_online', USER_OFFLINE:'user_offline', READ_RECEIPT:'read_receipt' } as const;
